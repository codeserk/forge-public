...
**sessionsTotal** | **number** |  | [default to undefined]
...
```typescript
import { EventusersEventUserResponse } from './api';

const instance: EventusersEventUserResponse = {
    city,
    country,
    deviceBrowser,
    deviceOS,
