...
**manageMembers** | **boolean** |  | [optional] [default to undefined]
...
```typescript
import { ProjectUpdateUserPermissionsRequest } from './api';

const instance: ProjectUpdateUserPermissionsRequest = {
    _delete,
    manageMembers,
    read,
    update,
