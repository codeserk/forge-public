...
If your site uses [View Transitions](https://docs.astro.build/en/guides/view-transitions/), the script listens to `astro:page-load` automatically. Every navigation gets tracked as a page view.
